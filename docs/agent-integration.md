...
- If `get_pro_status` already includes `recommended_actions`, wrappers can follow them directly for retry guidance without making a separate `get_pro_setup` call.
