...
func DefaultCapabilityPacks() []CapabilityPack {
	return []CapabilityPack{
		...
		},
		{
			...
			Tier:            "first_wave",
			CapabilityClass: "tool",
			UseWhen:         "Extract text from screenshots, scans, rendered PDF page images, UI images, or photos with RapidOCR-compatible PP-OCRv6 profiles.",
			...
			Inputs:          []string{"image file or rendered page image", "optional language hints", "optional model profile such as ppocrv6", "optional engine preference"},
